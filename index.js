...
const FillRow = ({
  ...
  return /*#__PURE__*/React$1.createElement("div", {
    className: `${fillRow} ${style$9[type]} ${blendModeDisabled ? withOutBlendMode : ''}`
