...
const BrushesIcon = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement("svg", {
    ...
    fillRule: "evenodd",
    clipRule: "evenodd",
    d: "M1.7295 1.598c-.062-.3093.1747-.598.4902-.598h1.6289l1.374.916.7773.5183V1h5.7802c.3156 0 .5522.2887.4903.598L11.19 7h1.0198l1.0412-5.2058C13.4366.866 12.7267 0 11.7801 0H4.9999v.5657L4.2773.084 4.1513 0H2.2198C1.2731 0 .5631.866.7487 1.7942L1.79 7h1.0198L1.7295 1.598z",
    fill: "#333"
  }), /*#__PURE__*/React__default['default'].createElement("mask", {
    id: "a",
    fill: "#fff"
  }, /*#__PURE__*/React__default['default'].createElement("path", {
    d: "M1 9c0-.5523.4477-1 1-1h10c.5523 0 1 .4477 1 1v1c0 1.1046-.8954 2-2 2H9l.2512 2.5124C9.3844 15.8443 8.3385 17 7 17c-1.3385 0-2.3844-1.1557-2.2512-2.4876L5 12H3c-1.1046 0-2-.8954-2-2V9z"
  })), /*#__PURE__*/React__default['default'].createElement("path", {
    d: "M5 12l.995.0995A1 1 0 005 11v1zm4 0v-1a1 1 0 00-.995 1.0995L9 12zm-4.2512 2.5124l-.995-.0995.995.0995zM2 9h10V7H2v2zm10 0v1h2V9h-2zM2 10V9H0v1h2zm3 1H3v2h2v-2zm6 0H9v2h2v-2zm-2.995 1.0995l.2512 2.5124 1.9901-.199-.2513-2.5124-1.99.199zm-2.2612 2.5124l.2512-2.5124-1.99-.199-.2513 2.5124 1.9901.199zM7 16c-.7469 0-1.3305-.6449-1.2562-1.3881l-1.99-.199C3.5616 16.3335 5.0697 18 7 18v-2zm-7-6c0 1.6569 1.3432 3 3 3v-2c-.5523 0-1-.4477-1-1H0zm12 0c0 .5523-.4477 1-1 1v2c1.6569 0 3-1.3431 3-3h-2zm-3.7438 4.6119C8.3305 15.3551 7.7469 16 7 16v2c1.9301 0 3.4383-1.6665 3.2463-3.5871l-1.9901.199zM12 9h2c0-1.1046-.8954-2-2-2v2zM2 7C.8954 7 0 7.8954 0 9h2V7z",
    fill: "#333",
    mask: "url(#a)"
  }), /*#__PURE__*/React__default['default'].createElement("path", {
    d: "M15.5 18.5h2v-2",
...
const Alignment = ({
  ...
  React$1.useEffect(() => {
    ...
    if (onChangeValue) onChangeValue(_res);
  }, [alignLeftState, bottomState, centerState, horizontalSpaceState, leftState, onChangeValue, rightState, verticalCenterState, verticalSpaceState]);
...
const SmartLayout = ({
  ...
  const [selectedV, setSelectedItemV] = React$1.useState('Scale');
  const [selectedH, setSelectedItemH] = React$1.useState('Scale');
  return /*#__PURE__*/React__default['default'].createElement("div", {
...
const AdjRow = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    onClick: () => onChangeValues('activeAdjustment')
  }, row.name), /*#__PURE__*/React__default['default'].createElement(IconButton, {
    className: btn,
    onClick: () => onChangeValues('visible')
    ...
    className: `${btn} ${minus}`,
    onClick: () => onChangeValues('selected')
...
const Adjustment = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
  ...
  }, text), actionBtn && /*#__PURE__*/React__default['default'].createElement("div", {
    ref: closeMenuBtn,
    className: `${layerBtnAction}`,
    onClick: () => setToggleAdjMenu(!toggleAdjMenu)
  }, actionBtn), toggleAdjMenu && /*#__PURE__*/React__default['default'].createElement(AdjMenu, {
    ...
    return /*#__PURE__*/React__default['default'].createElement(React$1.Fragment, {
      ...
      onChangeValues: field => updateActiveAdjustment({
        field,
        key
      })
    }) : '');
...
const FillRow = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    onChangeValues: setSelectedColor,
...
const Fill = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    className: `${layerBtnAction}`,
    onClick: () => addRow()
  }, actionBtn)), /*#__PURE__*/React__default['default'].createElement("div", {
    className: fillItems
  }, optionsState.map((item, key) => /*#__PURE__*/React__default['default'].createElement(FillRow, {
    key: `${item.id}`,
    label: "%",
    row: item,
    onChangeValues: _res => setValue(_res, key),
    removeRow: removeRow
  }))));
};
...
const Stroke = ({
  ...
  const [optionsState, setOptionsState] = React$1.useState(options);
  const [toggleMoreItems, setToggleMoreItems] = React$1.useState(false);
  const [capSelectedItem, setCapSelectedItem] = React$1.useState(false);
  const [trimPathSelectedItem, setTrimPathSelectedItem] = React$1.useState('');
  const [start, setStart] = React$1.useState(0);
  const [end, setEnd] = React$1.useState(100);
  ...
  const moreMenuTrimPathSelectOption = [{
    name: 'none',
    value: 'none'
  }, {
    name: 'trim1',
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
  ...
  }, optionsState.map((item, key) => /*#__PURE__*/React__default['default'].createElement(StrokeRow, {
    key: `${item.id}`,
    row: item,
    onChangeValues: _res => setValue(_res, key),
    removeRow: removeRow
    ...
    option: moreMenuCapSelectOption,
    onChangeValue: setCapSelectedItem,
    size: "medium",
    className: option,
    popupMenu: "left"
  })), /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    option: moreMenuTrimPathSelectOption,
    onChangeValue: setTrimPathSelectedItem,
    size: "medium",
    className: option,
    popupMenu: "left"
  })), /*#__PURE__*/React__default['default'].createElement("div", {
...
const FxRow = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
    ...
    onClick: () => onChangeValues('activeFilter')
  }, row.name), /*#__PURE__*/React__default['default'].createElement(IconButton, {
    className: btn,
    onClick: () => onChangeValues('visible')
  }, row.visible ? /*#__PURE__*/React__default['default'].createElement(EyeIcon, null) : /*#__PURE__*/React__default['default'].createElement(EyeOffIcon, null)), /*#__PURE__*/React__default['default'].createElement(IconButton, {
...
const Fx = ({
  ...
  return /*#__PURE__*/React__default['default'].createElement("div", {
  ...
  }, actionBtn), toggleFxMenu && /*#__PURE__*/React__default['default'].createElement(FxMenu, {
    ...
    return /*#__PURE__*/React__default['default'].createElement(React$1.Fragment, {
      ...
      onChangeValues: field => updateActiveFilter({
        field,
        key
      })
    }) : '');
...
const ToolsPanelPencilIcon = ({
  ...
  return (
    /*#__PURE__*/
    // <svg width={width} height={height} fill='none' viewBox='0 0 8 16'>
    //   <mask id='path-1-inside-1' fill='white'>
    //     <path d='M3.76689 0.601575L-7.01796e-08 10.3226L-9.51811e-08 14C-1.02691e-07 15.1046 0.89543 16 2 16L6 16C7.10457 16 8 15.1046 8 14L8 10.3226L4.23311 0.601575C4.15061 0.388682 3.84939 0.388682 3.76689 0.601575Z' />
    //   </mask>
    //   <path
    ...
    React__default['default'].createElement("svg", {
      ...
      d: "M3.7669.6016L0 10.3226V14c0 1.1046.8954 2 2 2h4c1.1046 0 2-.8954 2-2v-3.6774L4.2331.6016c-.0825-.213-.3837-.213-.4662 0z"
    })), /*#__PURE__*/React__default['default'].createElement("path", {
      d: "M0 10.3226l-.9324-.3613-.0676.1743v.187h1zM3.7669.6016l.9324.3613L3.767.6016zm.4662 0l.9324-.3613-.9324.3613zM8 10.3226h1v-.187l-.0676-.1743L8 10.3226zm-7.0676.3613l3.767-9.721-1.865-.7226-3.7668 9.721 1.8648.7226zM3.3007.9629l3.7669 9.721 1.8648-.7226L5.1656.2403l-1.865.7226zM7 10.3226V14h2v-3.6774H7zM1 14v-3.6774h-2V14h2zm5 1H2v2h4v-2zm-7-1c0 1.6569 1.3431 3 3 3v-2c-.5523 0-1-.4477-1-1h-2zm8 0c0 .5523-.4477 1-1 1v2c1.6569 0 3-1.3431 3-3H7zM4.6993.9629c-.2475.6387-1.1511.6387-1.3986 0L5.1655.2403c-.4124-1.0645-1.9186-1.0645-2.331 0l1.8648.7226z",
      fill: "#333",
      mask: "url(#a)"
    }), /*#__PURE__*/React__default['default'].createElement("path", {
      d: "M2 5.5l.2111.1056a4 4 0 003.5777 0L6 5.5",
      stroke: "#333"
    }))
  );
};
