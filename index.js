import React$1, { useRef, useState, useEffect, Fragment, Component, createRef } from 'react';
import { v4 } from 'uuid';
...
const Dropdown = ({
  ...
  return /*#__PURE__*/React$1.createElement("div", {
    className: `${dropdown} ${style$h[size]} ${toggleSearch || toggleOption ? open : ''} ${className ? className : ''}`,
    ref: menuWrapper
    ...
    autoHide: true,
    style: {
      width: size === 'medium' ? 172 : 144,
      height: dropDownMenuMaxHeight
    }
...
const Visibility = ({
  type = 'white',
  blendModeOptions = defaultOption$1,
  opacity,
  blendMode = {
    name: 'normal',
    value: 'Normal'
...
const SmartLayout = ({
  ...
  return /*#__PURE__*/React$1.createElement("div", {
    ...
    size: "small",
    dropDownMenuMaxHeight: dropDownMenuMaxHeight[1],
...
const DropdownOption = ({
  ...
  const [optionValueState, setOptionValueState] = useState(value);
  const [toggleOption, setToggleOption] = useState(false);
  const {
    dropdown,
    ddlOption,
    selectedItem
  } = style$h; // close menu by click outside.
  ...
  return /*#__PURE__*/React$1.createElement("div", {
    className: `${dropdown} ${ddlOption} ${className ? className : ''} ${style$h[type]}`,
    ref: menuWrapper
  }, toggleOption && options.length > 1 && /*#__PURE__*/React$1.createElement("ul", {
    className: `ddl-menu`
  }, /*#__PURE__*/React$1.createElement(Scrollbars$1, {
    autoHide: true,
    style: {
  ...
  }, options.map((option, key) => /*#__PURE__*/React$1.createElement("li", {
    key: key
  }, /*#__PURE__*/React$1.createElement("button", {
    type: "button",
    onClick: () => onClickOptionHandler(option)
...
const ColorPicker = ({
  ...
  }, [color, opacity]); // close color picker by click outside.
  ...
  return /*#__PURE__*/React$1.createElement("div", {
    className: `${colorPickerWrapper} ${className ? className : ''} ${style$9[size]}`
...
const FillRow = ({
  ...
  const [blendModeState, setBlendModeState] = useState(blendMode);
  const [selectedOpacity, setSelectedOpacity] = useState(opacity);
  return /*#__PURE__*/React$1.createElement("div", {
    className: `${fillRow} ${style$8[type]} ${blendModeDisabled ? withOutBlendMode : ''}`
...
const Fill = ({
  ...
  return /*#__PURE__*/React$1.createElement("div", {
    className: `${fill} ${style$7[type]}`
  }, /*#__PURE__*/React$1.createElement("div", {
    className: header
  }, /*#__PURE__*/React$1.createElement("label", {
    className: `${layerText} ${style$7[textColor]}`
...
const StrokeRow = ({
  ...
  return /*#__PURE__*/React$1.createElement("div", {
    className: `${strokeRow} ${style$6[type]}`
  }, /*#__PURE__*/React$1.createElement(ColorPicker, {
...
const Stroke = ({
  ...
  return /*#__PURE__*/React$1.createElement("div", {
    className: `${stroke} ${style$5[type]}`,
    ref: moreMenuRef
  }, /*#__PURE__*/React$1.createElement("div", {
    className: header
  }, /*#__PURE__*/React$1.createElement("label", {
    className: `${layerText} ${style$5[textColor]}`
  }, "Stroke"), /*#__PURE__*/React$1.createElement("div", {
    className: `${layerBtnAction}`
  }, !strokeOptionDisabled ? /*#__PURE__*/React$1.createElement(IconButton, {
    onClick: () => setToggleMoreItems(!toggleMoreItems)
...
const StrokeOption = ({
  ...
  return /*#__PURE__*/React$1.createElement("div", {
    ...
    option: capOption,
    onChange: _cap => {
      setCapOptionSelected(_cap);
      onChange({
        cap: _cap.value,
        case: caseSelected,
        trim: trimOptionSelected.value,
        start: startS,
        end: endS,
        offset: offsetS
      });
    ...
    row: caseOption,
    onChange: _case => {
      setCaseSelected(_case);
      onChange({
        cap: capOptionSelected.value,
        case: _case,
        trim: trimOptionSelected.value,
        start: startS,
        end: endS,
...
const TextBackgroundRow = ({
  ...
  return /*#__PURE__*/React$1.createElement("div", {
    className: `${textBackgroundRow} ${style$4[type]}`
  }, toggleColorPicker && /*#__PURE__*/React$1.createElement("div", {
    className: colorPickerModal,
...
const TextBackground = ({
  ...
  return /*#__PURE__*/React$1.createElement("div", {
    className: `${fill} ${style$3[type]}`
  }, /*#__PURE__*/React$1.createElement("div", {
    className: header
  }, /*#__PURE__*/React$1.createElement("label", {
    className: `${layerText} ${style$3[textColor]}`
